            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{ route('timeslots.index') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Periods">Periods</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('admin.professors.index') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Professors">Professors</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('slots.create') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Assign Slots">Assign Slots</div>
                    </a>
                </li>
            </ul>
        </li>
