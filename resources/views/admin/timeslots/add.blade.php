        ...
        <div class="card-body">
          ...
          <form action="{{route('room.store')}}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" id="basic-default-phone" name="capacity" class="form-control phone-mask" placeholder="room capacity in number" aria-label="658 799 8941" aria-describedby="basic-default-phone" />
              </div>
            </div>
